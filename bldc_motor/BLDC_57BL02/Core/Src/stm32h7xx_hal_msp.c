...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PA7     ------> ADC2_INP7
    */
    GPIO_InitStruct.Pin = DRV_01_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DRV_01_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DRV_02_Pin|DRV_03_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_INP9
    */
    HAL_GPIO_DeInit(SO1_GPIO_Port, SO1_Pin);

    HAL_GPIO_DeInit(SO2_GPIO_Port, SO2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA7     ------> ADC2_INP7
    */
    HAL_GPIO_DeInit(DRV_01_GPIO_Port, DRV_01_Pin);

    HAL_GPIO_DeInit(GPIOA, DRV_02_Pin|DRV_03_Pin);
